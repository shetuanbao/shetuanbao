...
public class RefreshableView extends LinearLayout implements View.OnTouchListener {
    ...
    /**
     * 琛屼竴浜涘叧閿�х殑鍒濆鍖栨搷浣滐紝姣斿锛氬皢涓嬫媺澶村悜涓婂亸绉昏繘琛岄殣钘忥紝缁橪istView娉ㄥ唽touch浜嬩欢
     */
    @Override
...
//                    yDown = event.getRawY();
//                }
//                // 婵″倹鐏夋＃鏍﹂嚋閸忓啰绀岄惃鍕瑐鏉堝湱绱敍宀冪獩缁傝崵鍩楃敮鍐ㄧ湰閸婇棿璐�0閿涘苯姘ㄧ拠瀛樻ListView濠婃艾濮╅崚棰佺啊閺堬拷銆婇柈顭掔礉濮濄倖妞傛惔鏃囶嚉閸忎浇顔忔稉瀣閸掗攱鏌�
//                ableToPull = true;
//            } else {
...
//            }
//        }
        if(view.getScrollY()<=0&&headerLayoutParams.topMargin>=hideHeaderHeight)
        {
            if (!ableToPull) {
                yDown = event.getRawY();
            }
